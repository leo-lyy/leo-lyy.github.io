---
layout: post
title: How to run LAMMPS on Windows with WSL2
date: 2023-9-15 22:25:00
description: Documenting the journey of environment setup on my new system.
tags: LAMPPS WSL2
categories: cs
tikzjax: true
---
...
> Documenting the journey of environment setup on my new system.
...
![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.001.png)

程序→启用或关闭Windows功能→勾选适用于Linux的Windows子系统

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.002.png)

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.003.png)

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.004.png)
...
![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.005.png)

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.006.png)

下载完成后即可在开始菜单中找到，点击运行，开始安装。

随后根据提示设置用户名和密码。

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.007.png)

至此我们已经完成了WSL的安装，在PowerShell（在Win搜索栏中搜索打开）中输入`wsl -l -v` 即可查看WSL的运行状态和版本。

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.008.png)
...
![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.009.png)

此外在还需要在控制面板的Windows功能里启用Hyper-V和虚拟机平台

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.010.png)

稍作片刻后，重启电脑

此外还要下载[WSL 2 Linux 内核](/assets/img/posts/WSL/https://wslstorestorage.blob.core.windows.net/wslblob/wsl_update_x64.msi)

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.011.png)
...
![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.012.png)
...
> “VS Code是世界上最好用的文本编辑器”

如果是第一次使用VS Code 建议在安装的时候勾选上这两个

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.013.png)

在拓展中搜索WSL，安装即可

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.014.png)

安装完成后，我们可以在点击左下角打开远程窗口，选择连接到WSL

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.015.png)
...
![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.017.png)
...
![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.018.png)
...
[CUDA官方安装指引](WSL/https://developer.nvidia.com/cuda-downloads?target_os=Linux&target_arch=x86_64&Distribution=WSL-Ubuntu&target_version=2.0&target_type=deb_network)

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.019.png)

NV官网给出了WSL 2的CUDA安装方式，根据网页下方的安装指引即可

安装完成后，可以在终端中输入`nvidia-smi`可以看到如下的显卡信息

![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.020.png)
...
![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.021.png)
...
```bash
cmake -C ../cmake/presets/basic.cmake -D PKG_OPENMP=yes -D PKG_GPU=on -D GPU_API=cuda -D GPU_ARCH=sm_75 ../cmake
```
...
![](/assets/img/posts/WSL/Aspose.Words.4a50e517-38f1-4da6-a33d-95a3331f5566.023.png)
